...
#define TRS_WAIT		LATBbits.LATB0
...
#define RTC_INT_IE		PIE10bits.INT2IE
#define RTC_INT_IP		IPR10bits.INT2IP
#define RTC_INT_IF		PIR10bits.INT2IF
#define RTC_INT_EDGE	INTCON0bits.INT2EDG
